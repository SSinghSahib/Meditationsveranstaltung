...
/*------ Zweite Tabelle Aktualisieren--------------*/
  ...
  /*------ Zweite Tabelle Aktualisieren--------------*/
    // echo " <tr>";
    // echo "   <td>TeilnehmerID</td>";
    // echo "   <td><input name='teilnehmerID' value='$TeilnehmerID' required hidden></td>";
    // echo "  </tr>";

    /* echo "<tr>";
    echo"  <td>Ankunftsort</td>";
    echo"  <td><select name='ankunftsort'>   
          <option value=' Flughafen'> Flughafen </option> Flughafen
          <option value='Hauptbahnhof'>Hauptbahnhof</option>Hauptbahnhof
          </select>";
    echo"  </td>";
    echo"  </tr>";*/
...
/*  echo " <tr>";
    echo "   <td>Ankunftsort</td>";
    echo "   <td><input name='ankunftsort' value='$Ankunftsort' required></td>";
    echo "  </tr>"; */ 
...
/*---------------------------------------- */
   /* echo "<tr>";
    ...
    /*echo " <tr>";
    echo "   <td>Abfahrtsort</td>";
    echo "   <td><input name='abfahrtsort' value='$Abfahrtsort' required></td>";
    echo "  </tr>";*/
